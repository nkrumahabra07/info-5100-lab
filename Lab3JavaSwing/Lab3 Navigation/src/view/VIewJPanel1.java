...
//this.userInfo.setPic(new ImageIcon(edited_image));
                ...
                JOptionPane.showMessageDialog(this, "The selected file could not be read as an image.", "Error", JOptionPane.ERROR_MESSAGE);
                }
            } catch (Exception ex) {
   ...
   private void PopulateData() throws Exception {
      this.enterFirstNameTextField.setText(p1.getFirstName() + " " + p1.getLastName());
      String gender = p1.Gender();
